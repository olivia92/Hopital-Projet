...
public class Fenetre extends JFrame implements ActionListener, ItemListener {
    ...
    private final JButton test1;
    
    
    /**création menu*/
    private JMenuBar menuBar = new JMenuBar();
    private JMenu test = new JMenu("Recherche d'information");
    private JMenu test2 = new JMenu("Mise à jour des données");
    private JMenu test3 = new JMenu("Reporting");
    ...
    public Fenetre() {
        ...
        super("Projet d'utilisation de hopital dans MySQL");
        ...
        test1 = new JButton("Recherche d'informations");
    ...
    private void remplirRequetes() {
        maconnexion.ajouterRequete("SELECT prenom, nom FROM malade WHERE mutuelle = 'MAAF';");
